...
| `docs/exec-plans/completed/billing-learning-hours.md` | Billing learning-hour estimates | `exec-plan-completed` | `completed` | `repo` | `-` | `true` |
...
| `docs/product-specs/billing-learning-hours-estimate.md` | Billing reading learning-hour estimates | `product-spec` | `implemented` | `shared` | `2026-09-20` | `true` |
