...
| `docs/design-docs/referral-invitation-rewards.md` | Referral Invitation Rewards | `design-doc` | `proposed` | `shared` | `2026-06-08` | `true` |
...
| `docs/exec-plans/active/referral-invitation-rewards.md` | Referral Invitation Rewards Implementation Plan | `exec-plan-active` | `active` | `repo` | `-` | `true` |
