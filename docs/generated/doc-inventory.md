...
| `docs/exec-plans/completed/markdown-flow-agent-memory-migration.md` | Expose Existing Course Variables through a Memory Facade | `exec-plan-completed` | `completed` | `repo` | `-` | `true` |
