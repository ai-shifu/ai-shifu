...
| `docs/exec-plans/active/backend-overhaul-master.md` | Backend Overhaul Master Plan: Inventory, Optimization, Go Migration | `exec-plan-active` | `active` | `repo` | `-` | `true` |
...
| `docs/exec-plans/active/learn-run-decomposition.md` | ExecPlan: Learn /run Chain Decomposition (B6) | `exec-plan-active` | `active` | `repo` | `-` | `true` |
