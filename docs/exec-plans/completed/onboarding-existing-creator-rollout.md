...
> Lifecycle review, 2026-09-26: Completed original scope. The existing-account rollout shipped; later retirement of the home entry supersedes that part of the old UI while editor behavior remains. Merge evidence: [#1933](https://github.com/ai-shifu/ai-shifu/pull/1933) (`ac23e4dc9`), [#2823](https://github.com/ai-shifu/ai-shifu/pull/2823) (`30e2fc2ec`)
