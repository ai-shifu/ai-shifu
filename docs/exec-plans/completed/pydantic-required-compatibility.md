...
> Lifecycle review, 2026-09-26: Completed original scope. The removed legacy constructs, AST guard and recorded regression/CI verification complete compatibility cleanup. Merge evidence: [#2912](https://github.com/ai-shifu/ai-shifu/pull/2912) (`38dcfafbf`), [#2913](https://github.com/ai-shifu/ai-shifu/pull/2913) (`d6141f1ca`)
