# Ruff rule delivery journal through 2026-09-26

> Historical rule-unit census, decisions and test evidence. Current continuation lives in `docs/exec-plans/active/ruff-rule-minimization.md`; do not execute old merge tasks or use old counts as a fresh census.
