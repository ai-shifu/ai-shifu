...
> Lifecycle review, 2026-09-26: Unverified historical checklist and runbook, not proof of completed UTC acceptance. Old machine-local commands are historical; current guidance is the engineering baseline. Do not continue instructions from this snapshot.
