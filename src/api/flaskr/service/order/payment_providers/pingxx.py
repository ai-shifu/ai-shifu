...
class PingxxProvider(PaymentProvider):
    ...
    def ensure_client(self: object, app: Flask) -> object:
    ...
    def _sanitize_extra(self: object, extra: dict[str, object]) -> dict[str, object]:
    ...
    @_serialized_pingpp_config
    def retrieve_charge(self: object, *, charge_id: str, app: Flask) -> object:
