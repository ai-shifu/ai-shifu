...
_CAPABILITIES: tuple[BillingCapabilityDefinition, ...] = (
    ...
    BillingCapabilityDefinition(
        ...
        notes=("Creator orders, sync, refund, and topup flows stay enabled.",),
    ),
    BillingCapabilityDefinition(
        key="creator_entitlements",
        status="active",
        audience="creator",
        user_visible=True,
        default_enabled=True,
        route_entries=(("GET", "/entitlements"),),
        notes=("Creator entitlement snapshot is exposed in the billing center.",),
    ),
    BillingCapabilityDefinition(
        key="creator_reports",
        status="active",
        ...
        notes=("Creator daily usage and ledger reports are currently exposed.",),
    ),
    BillingCapabilityDefinition(
    ...
    BillingCapabilityDefinition(
        ...
        default_enabled=True,
        route_entries=(
            ("GET", "/api/admin/billing/domain-bindings"),
            ("GET", "/api/admin/billing/domain-audits"),
            ("POST", "/api/admin/billing/domains/bind"),
        ),
        notes=("Admin domain bind and audit screens remain enabled.",),
    ),
    BillingCapabilityDefinition(
        key="admin_reports",
        status="active",
