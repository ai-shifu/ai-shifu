...
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_DRAFT = 7941
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_CREATING = 7942
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_ACTIVE = 7943
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_REQUIRES_REPUBLISH = 7944
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_PROVIDER_INVALID = 7945
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_RETIRED = 7946
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_CLEANUP_REQUIRED = 7947
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_FAILED = 7948
...
BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_LABELS = {
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_DRAFT: "draft",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_CREATING: "creating",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_ACTIVE: "active",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_REQUIRES_REPUBLISH: "requires_republish",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_PROVIDER_INVALID: "provider_invalid",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_RETIRED: "retired",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_CLEANUP_REQUIRED: "cleanup_required",
    BILLING_CAMPAIGN_PROVIDER_DISCOUNT_STATUS_FAILED: "failed",
}
...
CREDIT_NOTIFICATION_CHANNEL_EMAIL = "email"
CREDIT_NOTIFICATION_RECIPIENT_TYPE_MOBILE = "mobile"
CREDIT_NOTIFICATION_RECIPIENT_TYPE_EMAIL = "email"
