...
BILLING_PROVIDER_PRICE_STATUS_DRAFT = 7901
BILLING_PROVIDER_PRICE_STATUS_ACTIVE = 7902
BILLING_PROVIDER_PRICE_STATUS_RETIRED = 7903
BILLING_PROVIDER_PRICE_STATUS_INVALID = 7904

BILLING_PROVIDER_PRICE_ACTIVE_SCOPE = "active"

BILLING_PROVIDER_CATALOG_EVENT_STATUS_RECEIVED = 7921
BILLING_PROVIDER_CATALOG_EVENT_STATUS_PROCESSED = 7922
BILLING_PROVIDER_CATALOG_EVENT_STATUS_SKIPPED = 7923
BILLING_PROVIDER_CATALOG_EVENT_STATUS_FAILED = 7924

BILLING_PROVIDER_CATALOG_HEALTH_OK = 7931
BILLING_PROVIDER_CATALOG_HEALTH_UNLINKED = 7932
BILLING_PROVIDER_CATALOG_HEALTH_DRIFT = 7933
BILLING_PROVIDER_CATALOG_HEALTH_INACTIVE = 7934
BILLING_PROVIDER_CATALOG_HEALTH_MODE_MISMATCH = 7935
BILLING_PROVIDER_CATALOG_HEALTH_ACCOUNT_MISMATCH = 7936
...
# Statuses a subscription can hold while it still entitles the creator, i.e.
# the set every "is this creator currently subscribed" query filters on.
...
BILLING_PROVIDER_CATALOG_EVENT_STATUS_LABELS = {
    BILLING_PROVIDER_CATALOG_EVENT_STATUS_RECEIVED: "received",
    BILLING_PROVIDER_CATALOG_EVENT_STATUS_PROCESSED: "processed",
    BILLING_PROVIDER_CATALOG_EVENT_STATUS_SKIPPED: "skipped",
    BILLING_PROVIDER_CATALOG_EVENT_STATUS_FAILED: "failed",
}

BILLING_PROVIDER_CATALOG_HEALTH_LABELS = {
    BILLING_PROVIDER_CATALOG_HEALTH_OK: "ok",
    BILLING_PROVIDER_CATALOG_HEALTH_UNLINKED: "unlinked",
    BILLING_PROVIDER_CATALOG_HEALTH_DRIFT: "drift",
    BILLING_PROVIDER_CATALOG_HEALTH_INACTIVE: "inactive",
    BILLING_PROVIDER_CATALOG_HEALTH_MODE_MISMATCH: "mode_mismatch",
    BILLING_PROVIDER_CATALOG_HEALTH_ACCOUNT_MISMATCH: "account_mismatch",
}
