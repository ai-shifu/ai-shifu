...
def make_script_dto(script_type, script_content, script_id, lesson_id=None,log_id=None) -> str:
    return (
        "data: "
        + json.dumps(
            ScriptDTO(script_type, script_content, lesson_id, script_id,log_id), default=fmt
        )
