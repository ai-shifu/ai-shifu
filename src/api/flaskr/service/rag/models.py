...
def kb_schema(dim: int):
    ...
    schema.add_field(field_name="doc_category_0", datatype=DataType.VARCHAR, max_length=64)
    schema.add_field(field_name="doc_category_1", datatype=DataType.VARCHAR, max_length=64)
    schema.add_field(field_name="doc_category_2", datatype=DataType.VARCHAR, max_length=64)
    ...
    schema.add_field(field_name="create_user", datatype=DataType.VARCHAR, max_length=128)
    schema.add_field(field_name="update_user", datatype=DataType.VARCHAR, max_length=128)
