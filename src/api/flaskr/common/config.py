...
Generate secure key: python -c "import secrets; print(secrets.token_urlsafe(32))" """,
    ...
    "MINIMAX_TTS_MODEL": EnvVar(
        name="MINIMAX_TTS_MODEL",
        default="speech-01-turbo",
        description="Minimax TTS model name (speech-01-turbo, speech-01-hd, etc.)",
        group="tts",
    ),
    "MINIMAX_TTS_VOICE_ID": EnvVar(
        name="MINIMAX_TTS_VOICE_ID",
        default="male-qn-qingse",
        description="Default voice ID for TTS synthesis",
        group="tts",
    ),
    "MINIMAX_TTS_SPEED": EnvVar(
        name="MINIMAX_TTS_SPEED",
        default=1.0,
        type=float,
    ...
    "MINIMAX_TTS_PITCH": EnvVar(
        name="MINIMAX_TTS_PITCH",
        default=0,
        type=int,
        description="TTS speech pitch (-12 to 12)",
        group="tts",
        validator=lambda x: -12 <= int(x) <= 12,
    ),
    "MINIMAX_TTS_EMOTION": EnvVar(
        name="MINIMAX_TTS_EMOTION",
        default="neutral",
        description="TTS emotion (happy, sad, angry, fearful, disgusted, surprised, calm, neutral)",
        group="tts",
    ),
    "MINIMAX_TTS_VOLUME": EnvVar(
        name="MINIMAX_TTS_VOLUME",
        default=1.0,
        type=float,
        description="TTS volume (0.1-10.0)",
        group="tts",
    ...
    "VOLCENGINE_TTS_RESOURCE_ID": EnvVar(
        ...
        description="Volcengine TTS Resource ID (seed-tts-1.0, seed-tts-2.0, seed-icl-1.0, etc.)",
        group="tts",
    ),
    "VOLCENGINE_TTS_MODEL": EnvVar(
        name="VOLCENGINE_TTS_MODEL",
        default="",
        description="Volcengine TTS model version (e.g., seed-tts-1.1 for improved quality)",
        group="tts",
    ),
    "VOLCENGINE_TTS_VOICE_ID": EnvVar(
        name="VOLCENGINE_TTS_VOICE_ID",
        default="zh_female_shuangkuaisisi_moon_bigtts",
        description="Default Volcengine voice ID for TTS synthesis",
        group="tts",
    ),
    "VOLCENGINE_TTS_SPEED": EnvVar(
        name="VOLCENGINE_TTS_SPEED",
        default=1.0,
        type=float,
        description="Volcengine TTS speech speed (0.5-2.0)",
        group="tts",
        validator=lambda x: 0.5 <= float(x) <= 2.0,
    ),
    "VOLCENGINE_TTS_PITCH": EnvVar(
        name="VOLCENGINE_TTS_PITCH",
        default=0,
        type=int,
        description="Volcengine TTS speech pitch (-12 to 12)",
        group="tts",
        validator=lambda x: -12 <= int(x) <= 12,
    ),
    "VOLCENGINE_TTS_EMOTION": EnvVar(
        name="VOLCENGINE_TTS_EMOTION",
        default="",
        description="Volcengine TTS emotion (e.g., angry, happy, sad)",
        group="tts",
    ),
    "VOLCENGINE_TTS_VOLUME": EnvVar(
        name="VOLCENGINE_TTS_VOLUME",
        default=1.0,
        type=float,
    ...
    "BAIDU_TTS_VOICE_ID": EnvVar(
        name="BAIDU_TTS_VOICE_ID",
        default="0",
        description="Baidu TTS voice ID (0=Xiaomei, 1=Xiaoyu, 3=Xiaoyao, 4=Yaya, 106=Bowen)",
        group="tts",
    ),
    "BAIDU_TTS_SPEED": EnvVar(
        name="BAIDU_TTS_SPEED",
        default=5,
        type=int,
        description="Baidu TTS speech speed (0-15, default 5)",
        group="tts",
        validator=lambda x: 0 <= int(x) <= 15,
    ),
    "BAIDU_TTS_PITCH": EnvVar(
        name="BAIDU_TTS_PITCH",
        default=5,
        type=int,
        description="Baidu TTS speech pitch (0-15, default 5)",
        group="tts",
        validator=lambda x: 0 <= int(x) <= 15,
    ),
    "BAIDU_TTS_VOLUME": EnvVar(
        name="BAIDU_TTS_VOLUME",
        default=5,
        type=int,
        description="Baidu TTS volume (0-15, default 5)",
        group="tts",
        validator=lambda x: 0 <= int(x) <= 15,
    ),
    ...
    "ALIYUN_TTS_VOICE_ID": EnvVar(
        name="ALIYUN_TTS_VOICE_ID",
        default="xiaoyun",
        description="Aliyun TTS voice ID (xiaoyun, xiaogang, zhimi_emo, etc.)",
        group="tts",
    ),
    "ALIYUN_TTS_SPEED": EnvVar(
        name="ALIYUN_TTS_SPEED",
        default=0,
        type=int,
        description="Aliyun TTS speech rate (-500 to 500, default 0)",
        group="tts",
        validator=lambda x: -500 <= int(x) <= 500,
    ),
    "ALIYUN_TTS_PITCH": EnvVar(
        name="ALIYUN_TTS_PITCH",
        default=0,
        type=int,
        description="Aliyun TTS pitch rate (-500 to 500, default 0)",
        group="tts",
        validator=lambda x: -500 <= int(x) <= 500,
    ),
    "ALIYUN_TTS_VOLUME": EnvVar(
        name="ALIYUN_TTS_VOLUME",
        default=50,
        type=int,
