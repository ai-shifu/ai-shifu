...
def parse_comments(cls) -> dict[str, str]:
...
def get_field_schema(typ, description: str = "") -> dict[str, object]:
...
def register_schema_to_swagger(cls) -> type[object] | dict[str, object]:
