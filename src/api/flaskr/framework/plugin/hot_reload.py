...
class PluginHotReloader:
    ...
    def reload_plugin(self: object, plugin_path: str) -> None:
    ...
    def _unload_plugin(self: object, plugin_path: str) -> None:
    ...
    def _register_plugin(self: object, module: object) -> None:
...
class PluginFileHandler(FileSystemEventHandler):
    ...
    def __init__(self: object, reloader: PluginHotReloader) -> None:
    ...
    def on_modified(self: object, event: object) -> None:
