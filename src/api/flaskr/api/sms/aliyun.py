    ...
    *,
    ...
    try:
        ...
        if response_code != "OK":
            ...
            if (
                response_code == "isv.BUSINESS_LIMIT_CONTROL"
                and "触发号码天级流控" in response_message
            ):
                # This is an expected provider rejection for one recipient, not
                # an application failure that should page operations.
