...
def get_all_provider_configs() -> dict:
    ...
    configured_default = _normalize_provider_name(get_config("TTS_PROVIDER") or "")
    if configured_default and configured_default not in _PROVIDER_REGISTRY:
        logger.warning("Ignoring unknown TTS_PROVIDER: %s", configured_default)
        configured_default = ""
    default_provider = configured_default or _auto_detect_provider_name()
