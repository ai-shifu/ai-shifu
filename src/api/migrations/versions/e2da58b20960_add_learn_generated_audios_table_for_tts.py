"""add learn_generated_audios table for TTS

Revision ID: e2da58b20960
Revises: c9c92880fc67
Create Date: 2026-01-04 09:25:15.516501
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "sample_rate", sa.Integer(), nullable=False, comment="Audio sample rate"
        ),
        sa.Column(
            "voice_id",
            sa.String(length=64),
    ...
    with op.batch_alter_table("learn_generated_audios", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_learn_generated_audios_user_bid"), ["user_bid"], unique=False
        )
