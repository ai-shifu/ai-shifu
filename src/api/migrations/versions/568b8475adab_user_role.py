...
def upgrade():
    ...
    with op.batch_alter_table('user_info', schema=None) as batch_op:
        batch_op.add_column(sa.Column('is_admin', sa.Boolean(), nullable=False, comment='is admin'))
        batch_op.add_column(sa.Column('is_creator', sa.Boolean(), nullable=False, comment='is creator'))
