"""canonicalize billing product catalog

Revision ID: 9a6b3c2d1e4f
Revises: e5c6f7a8b9d0
...
revision = "9a6b3c2d1e4f"
down_revision = "e5c6f7a8b9d0"
branch_labels = None
depends_on = None
...
def upgrade():
    _upsert_products(_PRODUCT_ROWS)
