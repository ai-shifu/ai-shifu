...
class _FakeResponse:
    ...
    def iter_lines(self: object, decode_unicode: object = True) -> object:
        _ = decode_unicode
...
def test_streaming_tts_minimax_http_stream_sends_one_request_on_finalize(
    ...
    class _FakeMinimaxProvider:
        def stream_synthesize(self: object, **kwargs: object) -> object:
...
def test_streaming_tts_minimax_http_stream_falls_back_for_partial_subtitles(
    ...
    class _FakeMinimaxProvider:
        def stream_synthesize(self: object, **_kwargs: object) -> object:
            yield SimpleNamespace(
                audio_data=b"fake-mp3",
                is_final=False,
                duration_ms=0,
...
def test_streaming_tts_minimax_http_stream_falls_back_when_stream_audio_invalid(
    ...
    class _FakeMinimaxProvider:
        ...
        def synthesize(self: object, **kwargs: object) -> object:
