...
def test_placeholders_carry_each_ancestors_own_bid(attend_app) -> None:
...
def test_existing_ancestor_record_is_reused_not_duplicated(attend_app) -> None:
...
def test_second_call_returns_leaf_record_without_new_rows(attend_app) -> None:
...
def test_direct_ancestor_call_stamps_own_bids(attend_app) -> None:
