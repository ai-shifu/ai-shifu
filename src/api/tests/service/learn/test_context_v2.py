...
class OutlinePathGuardTests(unittest.TestCase):
    ...
    def test_get_next_outline_item_ignores_missing_current_outline_item(
        self: object,
    ) -> None:
        ctx = _make_context()
    ...
    def test_find_outline_path_returns_path_when_outline_exists(self: object) -> None:
        root = HistoryItem(
            bid="shifu-bid",
            id=1,
            type="shifu",
    ...
    def test_find_outline_path_raises_app_error_when_outline_missing(
        self: object,
    ) -> None:
...
class CollectAsyncGeneratorTests(unittest.TestCase):
    ...
    def test_without_running_loop(self: object) -> None:
        ctx = _make_context()
    ...
    def test_inside_running_loop(self: object) -> None:
        ctx = _make_context()
...
class NextChapterInteractionTests(unittest.TestCase):
    ...
    def test_emits_and_persists_button_once(self: object) -> None:
        with self.app.app_context():
            events = list(
...
class AccessGateFeedbackHelperTests(unittest.TestCase):
    ...
    def test_detects_blocking_access_gate(self: object) -> None:
        ctx = _make_context()
        ctx._is_paid = False
...
class CompletionTailInteractionTests(unittest.TestCase):
    ...
    def test_emits_feedback_and_next_when_both_conditions_met(self: object) -> None:
        ctx = _make_context()
        calls: list[str] = []
    ...
    def test_skips_next_when_no_next_outline(self: object) -> None:
        ctx = _make_context()
        calls: list[str] = []
    ...
    def test_emits_only_next_when_not_completed(self: object) -> None:
        ctx = _make_context()
        calls: list[str] = []
...
class RuntimeOutlineBlockCountTests(unittest.TestCase):
    ...
    def test_get_next_outline_item_uses_runtime_block_count_for_leaf_outline(
        ...
        class _Column:
            ...
            def in_(self: object, _values: object) -> object:
                return self

            def __eq__(self: object, _other: object) -> "_Column":
                return self
        ...
        class _FakeQuery:
            def filter(self: object, *_args: object, **_kwargs: object) -> object:
                return self

            def all(self: object) -> object:
        ...
        class _FakeMarkdownFlow:
            ...
            def get_all_blocks(self: object) -> object:
    ...
    def test_get_run_script_info_uses_outline_row_id_from_struct(self: object) -> None:
        ctx = _make_context()
...
class ExceptionGateFeedbackTests(unittest.TestCase):
    ...
    def test_emits_feedback_for_latest_completed_progress(self: object) -> None:
        with self.app.app_context():
    ...
    def test_skips_when_no_completed_progress(self: object) -> None:
        with self.app.app_context():
            events = list(self.ctx._emit_feedback_after_exception_gate())
            assert events == []

    def test_skips_completed_progress_without_generated_blocks(self: object) -> None:
        with self.app.app_context():
            dao.db.session.add(
                LearnProgressRecord(
...
class ExceptionGateInteractionPersistenceTests(unittest.TestCase):
    ...
    def test_emits_gate_interaction_without_existing_progress(self: object) -> None:
        with self.app.app_context():
            events = list(
...
class StreamTtsGateTests(unittest.TestCase):
    ...
    def test_should_stream_tts_respects_preview_and_listen(self: object) -> None:
        ctx = _make_context()
    ...
    def test_iter_stream_result_with_idle_callback_drains_while_waiting(
        self: object,
    ) -> None:
    ...
    def test_iter_stream_result_with_idle_callback_stops_and_cleans_up(
        self: object,
    ) -> None:
        ...
        class ClosableStream:
            ...
            def __iter__(self: object) -> "ClosableStream":
                return self
...
class ReloadFromElementBidTests(unittest.TestCase):
    ...
    def test_reload_element_bid_realigns_progress_to_source_block(self: object) -> None:
        with self.app.app_context():
            progress = LearnProgressRecord(
                progress_record_bid="progress-1",
                shifu_bid="shifu-1",
    ...
    def test_reload_preserves_ask_and_answer_blocks(self: object) -> None:
        with self.app.app_context():
            progress = LearnProgressRecord(
...
class StreamTtsTeardownTests(unittest.TestCase):
    ...
    def test_teardown_flushes_content_then_finalizes_tts(self: object) -> None:
        ...
        class _FakeProcessor:
            ...
            def finalize(self: object, *, commit: object = True) -> object:
    ...
    def test_teardown_skips_emit_on_generator_exit(self: object) -> None:
...
class MdflowContextCompatibilityTests(unittest.TestCase):
    ...
    def test_init_ignores_visual_mode_when_api_missing(self: object) -> None:
    ...
    def test_init_calls_visual_mode_when_api_exists(self: object) -> None:
        class FakeMarkdownFlow:
            def __init__(self: object, *args: object, **kwargs: object) -> None:
                _ = (args, kwargs)
                self.visual_mode = None

            def set_visual_mode(self: object, visual_mode: object) -> None:
    ...
    def test_init_uses_explicit_output_language_when_enabled(self: object) -> None:
        class FakeMarkdownFlow:
            def __init__(self: object, *args: object, **kwargs: object) -> None:
                _ = (args, kwargs)
                self.output_language = None

            def set_output_language(self: object, language: object) -> object:
    ...
    def test_filter_context_removes_stale_english_output_instruction(
        self: object,
    ) -> None:
        context = [
            {
...
class RuntimeOutputLanguageTests(unittest.TestCase):
    ...
    def test_runtime_language_overrides_stale_profile_language(self: object) -> None:
        with patch(
    ...
    def test_runtime_language_overlays_stale_production_prompt_variables(
        self: object,
    ) -> None:
        stored_profile = {
...
class PreviewResolveLlmSettingsTests(unittest.TestCase):
    ...
    def test_falls_back_to_allowlist_when_persisted_model_not_allowed(
        self: object,
    ) -> None:
...
class PreviewResolveVariablesTests(unittest.TestCase):
    ...
    def test_injects_request_language_when_missing(self: object) -> None:
    ...
    def test_empty_sys_user_language_uses_request_language(self: object) -> None:
    ...
    def test_request_language_overrides_stale_profile_language(self: object) -> None:
    ...
    def test_keeps_existing_sys_user_language(self: object) -> None:
...
class CoursePromptCompositionTests(unittest.TestCase):
    ...
    def test_formal_preview_composes_request_prompt_with_current_learner(
        self: object,
    ) -> None:
    ...
    def test_formal_preview_reloads_profile_for_each_request(self: object) -> None:
    ...
    def test_preview_learner_lookup_failure_cleans_the_database_session(
        self: object,
    ) -> None:
...
class PreviewRunLlmLoggingTests(unittest.TestCase):
    ...
    def test_complete_logs_full_preview_output(self: object) -> None:
...
class LangfuseTraceFinalizationTests(unittest.TestCase):
    ...
    def test_runtime_context_uses_current_langfuse_client(self: object) -> None:
    ...
    def test_set_input_normalizes_structured_value_for_trace(self: object) -> None:
        ctx = _make_context()
        ctx._trace_args = {}
    ...
    def test_set_input_normalizes_python_literal_string_for_trace(self: object) -> None:
        ctx = _make_context()
        ctx._trace_args = {}
    ...
    def test_runtime_finalize_skips_empty_output_overwrite(self: object) -> None:
        ctx = _make_context()
    ...
    def test_runtime_finalize_uses_accumulated_output(self: object) -> None:
        ctx = _make_context()
        ctx._trace = _FakeLangfuseTrace()
        ctx._trace_root_span = _FakeLangfuseSpan()
        ctx._trace_args = {
    ...
    def test_append_langfuse_output_normalizes_python_literal_string(
        self: object,
    ) -> None:
        ctx = _make_context()
        ctx._langfuse_output_chunks = []
...
class PreviewLangfuseTraceTests(unittest.TestCase):
    ...
    def test_stream_preview_sets_session_id_and_finalizes_root_span(
        self: object,
    ) -> None:
        ...
        class _FakePreviewContextStore:
            ...
            def get_context(self: object, *_args: object, **_kwargs: object) -> object:
                return []
        ...
        class _FakePreviewMdflowContext:
            ...
            def get_block(self: object, _block_index: object) -> object:
                return types.SimpleNamespace(
                    block_type=PreviewBlockType.CONTENT, content="Prompt block"
                )

            def process(self: object, **_kwargs: object) -> object:
                return (
                    item
                    for item in [
                        types.SimpleNamespace(
        ...
        class _FakePreviewAdapter:
            ...
            def process(self: object, events: object) -> object:
                return events
...
class PreviewElementizationTests(unittest.TestCase):
    ...
    def test_preview_content_events_preserve_stream_parts(self: object) -> None:
    ...
    def test_preview_content_stream_emits_element_and_done(self: object) -> None:
...
class _InMemoryCache:
    ...
    def setex(self: object, key: str, _ttl: int, value: object) -> None:
...
class PreviewSentPromptCaptureTests(unittest.TestCase):
    ...
    def test_iter_preview_generated_events_captures_prompt(self: object) -> None:
    ...
    def test_update_preview_context_prefers_sent_prompt(self: object) -> None:
...
class PreviewContextStoreTruncationTests(unittest.TestCase):
    ...
    def _populate(self: object, store: object, doc: object, indices: object) -> None:
        for idx in indices:
            store.append_context(doc, idx, f"u{idx}", f"a{idx}")

    def test_sequential_blocks_accumulate(self: object) -> None:
    ...
    def test_reselect_drops_entries_at_or_above_block_index(self: object) -> None:
        store, _cache, doc = _make_preview_store()
        self._populate(store, doc, [0, 1, 2, 3])
    ...
    def test_repeated_reselect_does_not_grow(self: object) -> None:
        store, _cache, doc = _make_preview_store()
        self._populate(store, doc, [0, 1, 2, 3])
        for _ in range(5):
    ...
    def test_backtrack_to_earlier_block(self: object) -> None:
        store, _cache, doc = _make_preview_store()
        self._populate(store, doc, [0, 1, 2, 3])
    ...
    def test_append_skips_when_both_empty(self: object) -> None:
        store, cache, doc = _make_preview_store()
        store.append_context(doc, 2, None, None)
        assert cache.store == {}

    def test_append_user_only_and_assistant_only(self: object) -> None:
        store, _cache, doc = _make_preview_store()
    ...
    def test_missing_document_hash_clears_entries(self: object) -> None:
        store, cache, doc = _make_preview_store()
        store.save(
    ...
    def test_empty_document_hash_clears_entries(self: object) -> None:
        store, cache, doc = _make_preview_store()
        store.save(
            {
                "document_hash": "",
    ...
    def test_replace_context_pairs_messages_with_sentinel_index(self: object) -> None:
        store, _cache, doc = _make_preview_store()
...
class RuntimeExceptionLangfuseTests(unittest.TestCase):
    ...
    def test_run_emits_gate_interaction_after_paid_exception(self: object) -> None:
...
class BuildContextFromBlocksTests(unittest.TestCase):
    ...
    def _blocks(self: object) -> object:
        return [
            types.SimpleNamespace(
                type=BLOCK_TYPE_MDCONTENT_VALUE,
                position=0,
    ...
    def test_interaction_block_kept_as_raw_assistant_message(self: object) -> None:
        app = Flask(__name__)
        with app.app_context():
    ...
    def test_transform_expands_interaction_without_adjacent_users(self: object) -> None:
        app = Flask(__name__)
        with app.app_context():
            messages = MdflowContextV2.build_context_from_blocks(
                self._blocks(), self.DOC, {"nickname": "Alice"}
...
class BuildContextGenerationPromptReplayTests(unittest.TestCase):
    ...
    def test_stored_prompt_replayed_verbatim_ignoring_current_variables(
        self: object,
    ) -> None:
        blocks = [
            types.SimpleNamespace(
    ...
    def test_missing_or_empty_prompt_falls_back_to_current_rendering(
        self: object,
    ) -> None:
        blocks = [
...
class StreamContentBlockPromptCaptureTests(unittest.TestCase):
    ...
    def _run_stream_phase(self: object, stream_items: object) -> object:
        ctx = _make_context()
        ctx.app = self.app
        ctx._input_type = "normal"
        ctx._preview_mode = False
    ...
    def test_llm_prompt_captured_and_passed_to_finalize(self: object) -> None:
    ...
    def test_promptless_stream_falls_back_to_rendered_block_source(
        self: object,
    ) -> None:
        ctx, _events = self._run_stream_phase(
...
class BuildContextNoVariableInteractionTests(unittest.TestCase):
    ...
    def _blocks(self: object, selection: object) -> object:
        return [
            types.SimpleNamespace(
                type=BLOCK_TYPE_MDCONTENT_VALUE,
                position=0,
    ...
    def test_selection_attached_via_user_answer_field(self: object) -> None:
        app = Flask(__name__)
        with app.app_context():
            messages = MdflowContextV2.build_context_from_blocks(
    ...
    def test_empty_selection_carries_empty_user_answer(self: object) -> None:
        app = Flask(__name__)
        with app.app_context():
            messages = MdflowContextV2.build_context_from_blocks(
    ...
    def test_library_expands_answer_and_skips_empty_turns(self: object) -> None:
    ...
    def test_variable_free_text_input_carries_the_learner_answer(self: object) -> None:
...
class TraceSessionBindingTests(unittest.TestCase):
    ...
    def _context(self: object, trace: object) -> object:
        ctx = _make_context()
        ctx.app = MagicMock()
        ctx._trace = trace
        ctx._trace_id = "f" * 32
    ...
    def test_binding_pushes_the_session_id_to_langfuse_immediately(
        self: object,
    ) -> None:
    ...
    def test_binding_without_a_trace_does_not_raise(self: object) -> None:
