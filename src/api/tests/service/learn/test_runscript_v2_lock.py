...
class FakeLock:
    ...
    def acquire(self: object, blocking: object = True) -> object:
        _ = blocking
...
class FakeCacheProvider:
    ...
    def lock(self: object, *_args: object, **_kwargs: object) -> object:
        return self._lock

    def setex(self: object, key: str, _time_in_seconds: int, value: object) -> object:
...
def test_run_script_inner_ask_mode_routes_events_through_element_adapter(
    ...
    class FakeRunScriptContext:
        ...
        def reload(self: object, *_args: object, **_kwargs: object) -> object:
            return []
...
def test_run_script_inner_rolls_back_on_unexpected_exception(
    ...
    class FakeRunScriptContext:
        ...
        def run(self: object, _app: object) -> None:
            message = "boom"
            raise RuntimeError(message)
