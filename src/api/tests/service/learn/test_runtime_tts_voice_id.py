...
def _patch_provider(
    ...
    default_voice_id: str = "default-voice",
) -> None:
...
def test_non_minimax_provider_returns_voice_id_unchanged(voice_app: Flask) -> None:
...
def test_minimax_empty_voice_id_returns_empty(voice_app: Flask) -> None:
    from flaskr.service.learn import learn_funcs
...
def test_minimax_builtin_voice_is_kept(
    voice_app: Flask, monkeypatch: pytest.MonkeyPatch
) -> None:
    from flaskr.service.learn import learn_funcs
