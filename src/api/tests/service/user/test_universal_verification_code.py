...
class TestUniversalVerificationCodeOptimization:
    ...
    def test_sms_verification_logic_without_universal_code(self):
        ...
        with (
            patch("flaskr.service.user.common.redis", mock_redis),
            ...
            with pytest.raises(Exception):  # raise_error will throw exception
                with patch(
                    "flaskr.service.user.common.raise_error",
                    side_effect=Exception("USER.SMS_SEND_EXPIRED"),
                ):
            ...
            with (
                patch("flaskr.service.user.common.User") as mock_user,
        ...
        with (
            ...
            with (
                ...
                result = verify_sms_code(
                    mock_app, "user123", "1234567890", universal_code
                )
                assert result is not None
    ...
    def test_mail_verification_logic_without_universal_code(self):
        ...
        with (
            ...
            with pytest.raises(Exception):  # raise_error will throw exception
                with patch(
                    "flaskr.service.user.common.raise_error",
                    side_effect=Exception("USER.MAIL_SEND_EXPIRED"),
                ):
    ...
    def test_mail_verification_logic_with_universal_code(self):
        ...
        with (
            ...
            with (
                ...
                # Should succeed with universal code even when no stored code
                result = verify_mail_code(
                    mock_app, "user123", "test@example.com", universal_code
                )
                assert result is not None
