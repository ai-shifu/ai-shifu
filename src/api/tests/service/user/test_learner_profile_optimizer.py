...
def test_optimizer_prompt_targets_the_downstream_learner_context_contract():
    ...
    for required_contract in (
        ...
        "end that line with a boundary that names the reference",
        "prohibits imitation or reproduction",
        "Never otherwise tell the AI to emulate or borrow from it",
        "never create a separate category for the boundary",
