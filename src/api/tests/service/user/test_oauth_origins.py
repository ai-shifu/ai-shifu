...
class TestIsAllowedOAuthOrigin:
    ...
    def test_platform_origin_is_allowed(self: object, app: object) -> None:
        assert oauth_origins.is_allowed_oauth_origin(app, PLATFORM_ORIGIN) is True

    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_verified_custom_domain_is_allowed(self: object, app: object) -> None:
        assert oauth_origins.is_allowed_oauth_origin(app, CUSTOM_ORIGIN) is True

    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_unknown_domain_is_refused(self: object, app: object) -> None:
    ...
    def test_unverified_custom_domain_is_refused(
        self: object, app: object, monkeypatch: object
    ) -> None:
    ...
    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_http_custom_domain_is_refused(self: object, app: object) -> None:
    ...
    def test_malformed_origins_are_refused(
        self: object, app: object, value: object
    ) -> None:
        assert oauth_origins.is_allowed_oauth_origin(app, value) is False

    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_path_and_query_are_stripped(self: object, app: object) -> None:
        assert (
...
class TestNormalizeOrigin:
    ...
    def test_bare_origin_is_kept(self: object) -> None:
        assert oauth_origins.normalize_origin(CUSTOM_ORIGIN) == CUSTOM_ORIGIN

    def test_explicit_default_port_is_dropped(self: object) -> None:
    ...
    def test_non_default_port_is_refused(self: object) -> None:
        assert oauth_origins.normalize_origin(f"{CUSTOM_ORIGIN}:8443") == ""

    def test_userinfo_is_refused(self: object) -> None:
    ...
    def test_malformed_port_is_refused(self: object) -> None:
...
class TestPortAndUserinfoAreNotServedDomains:
    ...
    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_non_default_port_on_a_verified_domain_is_refused(
    ...
    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_userinfo_on_a_verified_domain_is_refused(
        self: object, app: object
    ) -> None:
        assert (
    ...
    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_explicit_default_port_still_resolves(self: object, app: object) -> None:
        assert (
...
class TestResolveStateReturnOrigin:
    ...
    @pytest.mark.usefixtures("_verified_custom_domain")
    def test_returns_the_recorded_origin(self: object, app: object) -> None:
        state = _encode_state(app, {"origin": CUSTOM_ORIGIN})
        assert resolve_state_return_origin(app, state) == CUSTOM_ORIGIN

    def test_revoked_domain_is_refused_mid_flight(
        self: object, app: object, monkeypatch: object
    ) -> None:
    ...
    def test_state_without_origin_returns_empty(self: object, app: object) -> None:
        state = _encode_state(app, {"login_context": "default"})
        assert resolve_state_return_origin(app, state) == ""

    def test_tampered_state_returns_empty(self: object, app: object) -> None:
        assert resolve_state_return_origin(app, "not-a-valid-jwt") == ""

    def test_missing_state_returns_empty(self: object, app: object) -> None:
...
class TestInitiatorPairing:
    ...
    def test_the_starting_session_may_complete_the_flow(self: object) -> None:
        payload = {"origin": CUSTOM_ORIGIN, "initiator_user_id": "user-1"}
        _require_matching_initiator(payload, "user-1")

    def test_another_session_cannot_complete_the_flow(
        self: object, app: object
    ) -> None:
    ...
    def test_an_anonymous_callback_cannot_complete_a_forwarded_flow(
        self: object, app: object
    ) -> None:
        payload = {"origin": CUSTOM_ORIGIN, "initiator_user_id": "user-1"}
    ...
    def test_an_origin_without_an_initiator_is_refused(
        self: object, app: object
    ) -> None:
    ...
    def test_same_domain_flows_are_unaffected(self: object) -> None:
