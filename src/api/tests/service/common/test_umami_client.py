...
def test_get_course_visit_count_30d_returns_fetched_value_when_cache_write_fails(
    ...
    class CacheWrapper:
        ...
        def delete(self: object, *keys: str) -> object:
            return self._cache.delete(*keys)

        def setex(self: object, key: object, ttl: object, value: object) -> None:
            _ = (key, ttl, value)
...
def test_get_course_visit_count_30d_waits_for_cache_on_lock_contention(
    ...
    class CacheWrapper:
        def get(self: object, key: object) -> None:
            _ = key
...
def test_login_for_access_token_rechecks_cache_when_lock_is_busy(
    ...
    class CacheWrapper:
        ...
        def setex(self: object, key: object, ttl: object, value: object) -> object:
