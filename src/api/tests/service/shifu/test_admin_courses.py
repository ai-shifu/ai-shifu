...
def test_list_operator_courses_applies_quick_filters(monkeypatch: object) -> None:
    class FixedDateTime(datetime):
        @classmethod
        def now(cls: object, tz: object = None) -> datetime:  # noqa: ARG003 - matches datetime.now signature
...
class FakeColumn:
    ...
    def ilike(self: object, value: str) -> object:
        return ("ilike", self.name, value)

    def in_(self: object, value: object) -> object:
        return ("in", self.name, value)

    def desc(self: object) -> object:
        return ("desc", self.name)

    def label(self: object, alias: str) -> object:
...
class FakeLatestQuery:
    ...
    def filter(self: object, *conditions: object) -> object:
        self.filters.extend(conditions)
        return self

    def group_by(self: object, *columns: object) -> object:
        self.grouped_by.extend(columns)
        return self

    def subquery(self: object) -> object:
...
class FakeOuterQuery:
    ...
    def options(self: object, *options: object) -> object:
        self.options_calls.extend(options)
        return self

    def order_by(self: object, *ordering: object) -> object:
        self.ordering.extend(ordering)
        return self

    def with_entities(self: object, *columns: object) -> object:
...
class FakeSession:
    ...
    def query(self: object, target: object) -> object:
