...
class FakeColumn:
    ...
    def label(self, alias: str) -> tuple[str, str, str]:
...
class FakeLatestQuery:
    ...
    def filter(self, *conditions: object) -> FakeLatestQuery:
        self.filters.extend(conditions)
        return self

    def group_by(self, *columns: object) -> FakeLatestQuery:
        self.grouped_by.extend(columns)
        return self

    def subquery(self) -> FakeLatestSubquery:
...
class FakeOuterQuery:
    ...
    def filter(self, *conditions: object) -> FakeOuterQuery:
        self.filters.extend(conditions)
        return self

    def options(self, *options: object) -> FakeOuterQuery:
        self.options_calls.extend(options)
        return self

    def order_by(self, *ordering: object) -> FakeOuterQuery:
        self.ordering.extend(ordering)
        return self

    def with_entities(self, *columns: object) -> FakeOuterQuery:
