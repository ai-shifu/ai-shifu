...
def test_operator_credit_notification_services_delegate_to_billing(monkeypatch) -> None:
    app = Flask(__name__)
...
def test_operator_credit_notification_config_preserves_opt_out(monkeypatch) -> None:
    app = Flask(__name__)
