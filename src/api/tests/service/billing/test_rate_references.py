...
def test_llm_credit_1x_unit_cost_uses_fixed_config(monkeypatch, app) -> None:
    values = {
...
def test_llm_credit_1x_unit_cost_rejects_missing_or_invalid_config(monkeypatch) -> None:
