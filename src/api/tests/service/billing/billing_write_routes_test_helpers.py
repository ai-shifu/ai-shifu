...
def billing_write_client(monkeypatch: object) -> object:
    ...
    class FakeStripeProvider:
        def create_payment(self: object, *, request: object, app: object) -> object:
            _ = app
        ...
        def create_subscription(
            self: object, *, request: object, app: object
        ) -> object:
        ...
        def refund_payment(self: object, *, request: object, app: object) -> object:
            _ = app
