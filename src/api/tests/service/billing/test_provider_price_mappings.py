...
def test_provider_price_mapping_restores_retired_mapping_to_draft(app) -> None:
...
def test_provider_price_mapping_restore_rejects_non_retired_mapping(app) -> None:
