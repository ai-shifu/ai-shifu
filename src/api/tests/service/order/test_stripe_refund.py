...
class DummyStripeRefundProvider:
    ...
    def __init__(self: object, result: PaymentRefundResult) -> None:
        """Capture the result returned by refund requests."""
        self._result = result

    def refund_payment(self: object, *, request: object, app: object) -> object:  # pylint: disable=unused-argument
        _ = (request, app)
        return self._result
