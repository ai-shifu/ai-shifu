...
def test_normalize_mobile_handles_valid_edge_cases(input_phone, expected) -> None:
    assert normalize_mobile(input_phone) == expected


@pytest.mark.parametrize("input_phone", ["", None])
def test_normalize_mobile_rejects_empty_values(input_phone) -> None:
...
def test_parse_import_activation_entries_email_with_nickname(text, expected) -> None:
