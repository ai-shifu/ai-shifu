...
class TestResolvePaymentChannel:
    ...
    def test_pingxx_channel_requires_sub_channel(self: object) -> None:
    ...
    def test_pingxx_channel_missing_sub_channel_raises(self: object) -> None:
    ...
    def test_stripe_checkout_resolution(self: object) -> None:
        provider, sub_channel = _resolve_payment_channel(
            payment_channel_hint=None,
    ...
    def test_stripe_hint_defaults_to_payment_intent(self: object) -> None:
        provider, sub_channel = _resolve_payment_channel(
    ...
    def test_stripe_with_stored_channel_defaults(self: object) -> None:
        provider, sub_channel = _resolve_payment_channel(
            payment_channel_hint=None,
            channel_hint="",
