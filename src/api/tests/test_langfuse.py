...
class CoerceTraceIdTests(unittest.TestCase):
    ...
    def test_passes_through_valid_w3c_trace_id(self: object):
        valid = "0123456789abcdef0123456789abcdef"
        assert coerce_langfuse_trace_id(valid) == valid

    def test_maps_arbitrary_ids_deterministically(self: object):
    ...
    def test_generates_random_id_when_seed_missing(self: object):
...
class RequestTraceIdTests(unittest.TestCase):
    ...
    def test_prefers_thread_local_request_id(self: object):
    ...
    def test_falls_back_to_request_header(self: object):
    ...
    def test_uses_generated_uuid_when_request_id_is_missing(self: object):
...
class ResolveLangfuseTraceIdTests(unittest.TestCase):
    ...
    def test_prefers_explicit_string_trace_id(self: object):
    ...
    def test_falls_back_to_observation_string_trace_id(self: object):
        observation = types.SimpleNamespace(trace_id="observation-trace-id")
        assert resolve_langfuse_trace_id(observation) == "observation-trace-id"

    def test_ignores_non_string_trace_id_from_mock_client(self: object):
    ...
    def test_ignores_empty_string_trace_ids(self: object):
        thread_local.request_id = "request-trace-id"
