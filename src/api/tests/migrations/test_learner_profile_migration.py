...
def test_learner_profile_column_remains_nullable_for_rolling_writers() -> None:
    ...
    class _BatchOperations:
        def add_column(self: object, column: object) -> None:
            added_columns.append(column)

        def alter_column(self: object, column_name: object, **kwargs: object) -> None:
    ...
    class _Operations:
        ...
        def execute(self: object, statement: object) -> None:
