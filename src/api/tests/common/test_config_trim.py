...
class TestEnvironmentVariableTrimming:
    ...
    def test_trim_string_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_integer_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_boolean_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_float_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_in_validation(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_list_values(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_trim_with_interpolation(self, monkeypatch: pytest.MonkeyPatch) -> None:
