...
class TestEnvironmentVariableTrimming:
    ...
    def test_trim_string_values(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_integer_values(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_boolean_values(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_float_values(self: object, monkeypatch: object) -> None:
    ...
    def test_whitespace_only_uses_default(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_in_validation(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_list_values(self: object, monkeypatch: object) -> None:
    ...
    def test_trim_with_interpolation(self: object, monkeypatch: object) -> None:
    ...
    def test_required_with_whitespace_only_fails(
    ...
    def test_convert_type_method_trims(self: object) -> None:
