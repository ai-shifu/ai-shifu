...
class TestEnvironmentVariableTrimming:
    ...
    def test_trim_string_values(self, monkeypatch) -> None:
    ...
    def test_trim_integer_values(self, monkeypatch) -> None:
    ...
    def test_trim_boolean_values(self, monkeypatch) -> None:
    ...
    def test_trim_float_values(self, monkeypatch) -> None:
    ...
    def test_whitespace_only_uses_default(self, monkeypatch) -> None:
    ...
    def test_trim_in_validation(self, monkeypatch) -> None:
    ...
    def test_trim_list_values(self, monkeypatch) -> None:
    ...
    def test_trim_with_interpolation(self, monkeypatch) -> None:
    ...
    def test_required_with_whitespace_only_fails(self, monkeypatch) -> None:
