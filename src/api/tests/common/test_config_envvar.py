...
class TestEnvVarInitialization:
    ...
    def test_valid_envvar_with_defaults(self: object) -> None:
    ...
    def test_valid_envvar_required_no_default(self: object) -> None:
    ...
    def test_valid_envvar_optional_with_default(self: object) -> None:
    ...
    def test_invalid_required_with_default(self: object) -> None:
    ...
    def test_envvar_with_custom_validator(self: object) -> None:
    ...
    def test_envvar_with_dependencies(self: object) -> None:
...
class TestEnvVarTypeConversion:
    ...
    def test_convert_to_int(self: object) -> None:
    ...
    def test_convert_to_float(self: object) -> None:
    ...
    def test_convert_to_bool(self: object) -> None:
    ...
    def test_convert_string_remains_string(self: object) -> None:
    ...
    def test_convert_type_with_invalid_input(self: object) -> None:
...
class TestEnvVarValidation:
    ...
    def test_validate_with_no_validator(self: object) -> None:
    ...
    def test_validate_with_port_validator(self: object) -> None:
    ...
    def test_validate_with_email_validator(self: object) -> None:
    ...
    def test_validate_with_always_fail(self: object) -> None:
    ...
    def test_validate_with_range_validator(self: object) -> None:
...
class TestLLMModelMaxOutputTokensConfig:
    ...
    def test_parse_valid_routed_model_limits(self: object) -> None:
    ...
    def test_reject_invalid_routed_model_limits(self: object, value: object) -> None:
...
class TestEnvVarMultilineDescription:
    ...
    def test_single_line_description(self: object) -> None:
    ...
    def test_multi_line_description(self: object) -> None:
...
Line 3: Even more information."""
    ...
    def test_empty_description(self: object) -> None:
...
class TestEnvVarSecretHandling:
    ...
    def test_secret_field_true(self: object) -> None:
    ...
    def test_secret_field_false(self: object) -> None:
    ...
    def test_secret_field_default(self: object) -> None:
...
class TestEnvVarEdgeCases:
    ...
    def test_envvar_with_all_fields(self: object) -> None:
    ...
    def test_envvar_minimal_fields(self: object) -> None:
