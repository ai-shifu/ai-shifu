...
class TestEnvVarInitialization:
    ...
    def test_valid_envvar_with_defaults(self: object):
    ...
    def test_valid_envvar_required_no_default(self: object):
    ...
    def test_valid_envvar_optional_with_default(self: object):
    ...
    def test_invalid_required_with_default(self: object):
    ...
    def test_envvar_with_custom_validator(self: object):
    ...
    def test_envvar_with_dependencies(self: object):
...
class TestEnvVarTypeConversion:
    ...
    def test_convert_to_int(self: object):
    ...
    def test_convert_to_float(self: object):
    ...
    def test_convert_to_bool(self: object):
    ...
    def test_convert_string_remains_string(self: object):
    ...
    def test_convert_type_with_invalid_input(self: object):
...
class TestEnvVarValidation:
    ...
    def test_validate_with_no_validator(self: object):
    ...
    def test_validate_with_port_validator(self: object):
    ...
    def test_validate_with_email_validator(self: object):
    ...
    def test_validate_with_always_fail(self: object):
    ...
    def test_validate_with_range_validator(self: object):
...
class TestLLMModelMaxOutputTokensConfig:
    ...
    def test_parse_valid_routed_model_limits(self: object):
    ...
    def test_reject_invalid_routed_model_limits(self: object, value: object):
...
class TestEnvVarMultilineDescription:
    ...
    def test_single_line_description(self: object):
    ...
    def test_multi_line_description(self: object):
...
Line 3: Even more information."""
    ...
    def test_empty_description(self: object):
...
class TestEnvVarSecretHandling:
    ...
    def test_secret_field_true(self: object):
    ...
    def test_secret_field_false(self: object):
    ...
    def test_secret_field_default(self: object):
...
class TestEnvVarEdgeCases:
    ...
    def test_envvar_with_all_fields(self: object):
    ...
    def test_envvar_minimal_fields(self: object):
