...
class TestSecretKeyValidator:
    ...
    def test_secret_key_valid_values(self: object) -> None:
    ...
    def test_secret_key_invalid_values(self: object) -> None:
    ...
    def test_secret_key_required_field(self: object) -> None:
        """Test that SECRET_KEY is marked as required."""
        secret_key_env = ENV_VARS["SECRET_KEY"]
        assert secret_key_env.required is True

    def test_secret_key_is_secret(self: object) -> None:
    ...
    def test_secret_key_with_special_characters(
        self: object, monkeypatch: object
    ) -> None:
    ...
    def test_secret_key_trimming_during_get(self: object, monkeypatch: object) -> None:
    ...
    def test_custom_secret_key_validator(self: object) -> None:
