...
class TestEnvironmentVariableFallback:
    ...
    @pytest.fixture
    def setup_app(self, monkeypatch) -> tuple[Flask, Config]:
    ...
    def test_fallback_to_env_var_with_warning(self, setup_app) -> None:
    ...
    def test_fallback_cached_no_repeated_warning(self, setup_app, caplog) -> None:
    ...
    def test_undefined_var_not_in_env_returns_none(self, setup_app) -> None:
    ...
    def test_defined_var_no_fallback_warning(self, setup_app, caplog) -> None:
    ...
    def test_get_method_with_fallback(self, setup_app, caplog) -> None:
    ...
    def test_get_method_with_default(self, setup_app) -> None:
...
class TestEnhancedConfigFallback:
    ...
    @pytest.fixture
    def enhanced_config(self) -> EnhancedConfig:
        """Create EnhancedConfig instance."""
        return EnhancedConfig(ENV_VARS)

    def test_enhanced_get_no_fallback(self, enhanced_config, monkeypatch) -> None:
    ...
    def test_enhanced_get_caches_defined_values(
        self, enhanced_config, monkeypatch
    ) -> None:
    ...
    def test_enhanced_get_undefined_not_in_env(self, enhanced_config) -> None:
...
class TestIntegrationWithFlask:
    ...
    def test_flask_app_with_custom_env_vars(self, monkeypatch) -> None:
    ...
    def test_setitem_clears_cache_for_fallback(self, monkeypatch) -> None:
