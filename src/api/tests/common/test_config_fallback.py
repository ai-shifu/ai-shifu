...
class TestEnvironmentVariableFallback:
    ...
    @pytest.fixture
    def setup_app(self, monkeypatch: pytest.MonkeyPatch) -> tuple[Flask, Config]:
    ...
    def test_fallback_to_env_var_with_warning(
        self, setup_app: tuple[Flask, Config]
    ) -> None:
    ...
    def test_fallback_cached_no_repeated_warning(
        self, setup_app: tuple[Flask, Config], caplog: pytest.LogCaptureFixture
    ) -> None:
    ...
    def test_get_method_with_default(self, setup_app: tuple[Flask, Config]) -> None:
...
class TestEnhancedConfigFallback:
    ...
    def test_enhanced_get_no_fallback(
        self, enhanced_config: EnhancedConfig, monkeypatch: pytest.MonkeyPatch
    ) -> None:
...
class TestIntegrationWithFlask:
    ...
    def test_flask_app_with_custom_env_vars(
