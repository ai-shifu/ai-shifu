...
- Use one line per present category, never a paragraph. Start every line with a short label and colon. Style-only input must be exactly one language-style line.
