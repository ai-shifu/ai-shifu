...
const RATE_TABS_LIST_CLASSNAME =
  'h-auto justify-start gap-1 rounded-none border-b border-border bg-transparent p-0';
const RATE_TABS_TRIGGER_CLASSNAME =
  'rounded-none border-b-2 border-transparent px-0 pb-2 pt-0 text-sm font-medium text-muted-foreground shadow-none transition-colors data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none';
    ...
    <>
      ...
      >
        <AdminTitle
          ...
          tabs={
            <TabsList className={RATE_TABS_LIST_CLASSNAME}>
              {RATE_TABS.map(tab => (
                <TabsTrigger
                  key={tab}
                  value={tab}
                  className={RATE_TABS_TRIGGER_CLASSNAME}
                >
