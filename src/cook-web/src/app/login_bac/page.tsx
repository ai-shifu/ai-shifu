        ...
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-md space-y-2">
                    ...
                    <CardContent>
                        <form className="space-y-6">
                            ...
                            <div className="text-center  text-stone-900 text-base">
                                {t("login.want-to-experience-creation")} <a className='underline cursor-pointer hover:text-primary' href="http://">{t("login.apply-for-admission")}</a>
                            </div>
                        </form>
                    </CardContent>
                </Card>
                <div className="text-xs text-stone-500 text-center">
                    ...
                    <a className="px-1 text-xs text-stone-900 underline cursor-pointer hover:text-primary" href="/privacy">
                        {t("login.user-agreement")}
                    </a>
                    {t("login.and")}
                    <a className="px-1 text-xs text-stone-900 underline cursor-pointer hover:text-primary" href="/agreement">
