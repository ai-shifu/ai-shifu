...
export const NewChatComponents = ({
  ...
  // Handle iOS keyboard viewport jump by locking the scroll container height and preventing body scroll
  useEffect(() => {
    const isIOS =
    ...
    const syncViewportHeight = () => {
      ...
      const diff = window.innerHeight - height;
