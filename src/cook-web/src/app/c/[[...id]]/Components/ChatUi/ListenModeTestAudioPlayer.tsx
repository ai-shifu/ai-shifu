...
const normalizeAudioUrlList = (audioUrls: ListenModeAudioUrlItem[]) => {
  const order: string[] = [];
  const mapping = new Map<string, ListenModeAudioUrlItem>();
...
const ListenModeTestAudioPlayer = ({
  ...
  const playlist = useMemo(
    () => normalizeAudioUrlList(audioUrls),
    [audioUrls],
  );
  ...
  const currentSegments = useMemo(() => {
    ...
    return [...currentTrack.audioSegments].sort(
