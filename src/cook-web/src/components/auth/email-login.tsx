...
/**
 * Renders an email and password login form with validation, error handling, and internationalized UI.
 *
 * Displays input fields for email and password, a terms acceptance checkbox, and a submit button. Validates user input, handles login requests, and provides feedback through toast notifications. Invokes the provided callbacks on successful login or when the user selects "forgot password".
 *
 * @param onLoginSuccess - Callback invoked after a successful login.
 * @param onForgotPassword - Callback invoked when the user clicks the "forgot password" button.
 */
