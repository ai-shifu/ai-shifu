...
/**
 * Renders a form for users to submit their email address and request a password reset OTP.
 *
 * After successful OTP request, invokes the provided {@link onNext} callback with the entered email address.
 *
 * @param onNext - Callback function called with the email after a successful OTP send operation.
 */
