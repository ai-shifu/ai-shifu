 ...
 *
 * Renders a registration form that allows users to enter their phone number, receive an OTP via SMS, and verify the OTP to complete registration. Handles input validation, manages UI state, and provides feedback through toast notifications. Invokes the provided callback upon successful registration.
 *
 * @param onRegisterSuccess - Callback function called after successful registration and token storage.
 */
