...
/**
 * React component for a two-step email registration process with OTP verification and password setup.
 *
 * Presents a form that guides users through entering their email, verifying it via a one-time password (OTP), and setting a secure password. Handles input validation, OTP sending and verification, password strength checking, and displays localized feedback and error messages. Calls the provided {@link onRegisterSuccess} callback upon successful registration.
 *
 * @param onRegisterSuccess - Callback invoked after successful registration.
 */
