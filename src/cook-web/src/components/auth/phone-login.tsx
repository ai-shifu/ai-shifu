...
/**
 * React component for phone number login with OTP verification and internationalized UI.
 *
 * Renders a phone number input, OTP input, and terms acceptance checkbox, handling validation, OTP sending, and verification. Displays toast notifications for user feedback and manages UI state transitions throughout the login flow. Calls {@link onLoginSuccess} upon successful authentication.
 *
 * @param onLoginSuccess - Callback invoked after successful login.
 */
