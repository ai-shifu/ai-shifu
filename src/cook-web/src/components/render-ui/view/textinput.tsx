...
/**
 * Displays a read-only view of text input properties with internationalized labels.
 *
 * Renders the input name, key, prompt, model, and temperature values from the provided properties, using translation keys for all labels.
 */
