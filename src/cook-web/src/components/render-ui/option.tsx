 ...
 *
 * Allows users to modify the option name and manage associated buttons, including adding new buttons, editing button names and keys, and deleting buttons with confirmation when removing the last one. Changes are propagated to the parent component via the provided callback.
 *
 * @remark All user-facing text is localized using the `option` namespace.
 */
