...
/**
 * Renders a controlled form for editing text input prompt configuration with localization support.
 *
 * Allows users to modify prompt text, model selection, temperature, input key, and placeholder, updating local state and submitting changes via a callback.
 */
