...
/**
 * Renders a controlled form for editing a text input prompt configuration with nested properties.
 *
 * Allows users to modify prompt text, model selection, temperature, input key, and placeholder, with changes locally managed until confirmed.
 *
 * @param props - Contains the current prompt configuration and a callback to propagate changes.
 */
