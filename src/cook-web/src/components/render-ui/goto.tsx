...
/**
     * React component for configuring "goto" settings by selecting a profile variable and assigning navigation targets to its items.
     *
     * Displays a dropdown to select a profile variable, loads its items, and allows assigning a target node to each item. Changes are applied via the confirm button, invoking the {@link onChange} callback with updated settings.
     *
     * @param props - Component properties including current goto settings and a callback for applying changes.
     */
