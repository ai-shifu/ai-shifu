...
/**
 * Displays a dialog form for creating or editing a course scenario, including fields for name, description, keywords, avatar image, model selection, and price.
 *
 * The dialog supports form validation, keyword management, image upload with progress, and internationalized UI text. On submission, the scenario details are saved via an API call, and the dialog closes upon success.
 *
 * @param scenarioId - The unique identifier of the scenario to edit or create.
 * @param onSave - Callback invoked after a successful save operation.
 */
