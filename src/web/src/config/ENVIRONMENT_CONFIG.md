...
| `LEGAL_AGREEMENT_URL_DE_DE` | 德文服务协议URL     | 空字符串 | 留空则使用英文参考版本         |
...
| `LEGAL_PRIVACY_URL_DE_DE`   | 德文隐私政策URL     | 空字符串 | 留空则使用英文参考版本         |
...
const privacyUrlDeDE = legalUrls.privacy['de-DE']; // 德文隐私政策URL
