...
export function registerBillingTranslationUsage(t: BillingTranslator): void {
  void [
    ...
    t('module.billing.package.learningHours.value', { hours: '100' }),
    t('module.billing.package.learningHours.lessThanOne'),
    t('module.billing.package.learningHours.unavailable'),
