...
- **Microphone Access and Voice Processing**: When you explicitly start a voice follow-up, we request permission to use your microphone and stream audio from the session to a third-party AI service for speech recognition, spoken responses, and the bidirectional voice conversation. The product does not write original audio to its database or follow-up history, but it saves final transcripts as described above. If you do not grant microphone permission, voice follow-up will be unavailable, while features that do not require the microphone remain available.
