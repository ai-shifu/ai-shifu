...
- **Conversation Information**: To ensure the quality and stability of the service, we collect text you enter while interacting with the platform and final transcripts produced by voice follow-ups. Final voice follow-up transcripts are saved in follow-up history so that you can continue course conversations and manage your history.
...
- **Microphone Access and Voice Processing**: Opening the follow-up panel does not request microphone access. We request permission only when you explicitly enable the microphone, and stream its audio to a third-party AI service for speech recognition and spoken responses. Starting to type turns the microphone off; enabling it again requires another explicit action. You can submit text and hear spoken answers without microphone permission. Submitted text and final transcripts are saved in follow-up history; original audio is not written to the product database or history.
