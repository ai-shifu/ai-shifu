export const PROFILE_ONBOARDING_EVENTS = {
  ...
  DEFER_SHOWN: 'profile_onboarding_defer_shown',
  DEFER_CANCELLED: 'profile_onboarding_defer_cancelled',
  DEFER_ATTEMPT: 'profile_onboarding_defer_attempt',
  DEFER_RESULT: 'profile_onboarding_defer_result',
